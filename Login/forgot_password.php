...
<html lang="de" dir="ltr">
  <head>
    ...
    require 'nas-website/PHPMailer/src/PHPMailer.php'; // Pfad zu PHPMailer anpassen
    require 'nas-website/PHPMailer/src/SMTP.php';      // SMTP-Klasse einbinden
    require 'nas-website/PHPMailer/src/Exception.php'; // Fehlerbehandlung
